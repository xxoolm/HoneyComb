...
public final class ObjectUtils {
    ...
    private ObjectUtils() {
        throw new AssertionError("No java.util.ObjectUtils instances for you!");
    }
     ...
     * {@link java.util.function.Predicate}, {@code filter(ObjectUtils::isNull)}
     ...
     * @apiNote This method exists to be used as a
     * {@link java.util.function.Predicate}, {@code filter(ObjectUtils::nonNull)}
     * @see java.util.function.Predicate
     * @since 1.8
     */
